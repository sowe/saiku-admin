...
Date.prototype.format = function (format) {
    format = format.replace("DD", (this.getDate() < 10 ? '0' : '') + this.getDate()); // Pad with '0' if needed
    format = format.replace("MM", (this.getMonth() < 9 ? '0' : '') + (this.getMonth() + 1)); // Months are zero-based
