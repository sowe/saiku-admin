...
public class OlapController {
    ...
    @ResponseBody
    public Olap create(@RequestBody Olap olap)  {
    ...
    private void createFileOlap(Olap olap) {

    	PrintWriter writer;
		try {
			writer = new PrintWriter(confRepository.findFirst().getSaikuCube()+olap.getName(), "UTF-8");
